...
const UsuarioForm = ({ usuario, onClose, onSave }) => {
    ...
    return (
        <div className="p-4 max-w-7xl mx-auto h-[calc(100vh-1rem)] flex flex-col fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 min-h-0 overflow-hidden">
                ...
                <div className="lg:col-span-8 flex flex-col min-h-0 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden relative">
