                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-black text-slate-800 flex items-center gap-3">
                                    ...
                                    ND <span className="text-red-600">#{nota.numero}</span>
                                </h1>
                    ...
                    <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 ring-1 ring-slate-200/50 transition-all hover:shadow-md">
                        ...
                        <div className="mt-4 pt-4 border-t border-slate-50">
                            ...
                            <div className="flex items-baseline gap-2">
                                <span className="text-3xl font-black text-red-600 leading-tight">$ {new Intl.NumberFormat('es-AR', { minimumFractionDigits: 2 }).format(nota.total)}</span>
