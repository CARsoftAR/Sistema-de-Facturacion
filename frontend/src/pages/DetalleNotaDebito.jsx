                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                            Nota de Débito <span className="text-blue-600">#{nota.numero}</span>
                        </h1>
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="mt-2 pt-4 border-t border-gray-100">
                            <h4 className="text-xs text-gray-400 font-bold mb-1">TOTAL DÉBITO</h4>
                            <p className="text-3xl font-black text-red-600">$ {new Intl.NumberFormat('es-AR', { minimumFractionDigits: 2 }).format(nota.total)}</p>
                        </div>
                    </div>
                        ...
                        <div className="overflow-auto" style={{ height: '700px' }}>
                            <table className="w-full text-sm text-left relative min-h-full">
                                ...
                                <tfoot className="bg-gray-900 border-t border-gray-700 sticky bottom-0 z-10 shadow-[0_-2px_4px_rgba(0,0,0,0.2)]">
                                    <tr>
                                        <td colSpan="3" className="px-6 py-4 text-right text-gray-400 font-bold uppercase tracking-wider">Total Débito</td>
                                        <td className="px-6 py-4 text-right">
                                            <div className="text-2xl font-black text-red-500 flex items-baseline justify-end gap-1">
                                                <span>$</span>
