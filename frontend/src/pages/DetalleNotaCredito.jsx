        ...
        const fetchDetalle = async () => {
            try {
                ...
                if (data.ok) {
                    ...
                    setError(data.error || "No se pudo cargar la nota de crédito");
                }
            } catch (err) {
                console.error(err);
                        ...
                        <div className="card-body p-4">
                            <div className="row g-4">
                                ...
                                <div className="col-md-3">
                                    <h6 className="text-uppercase text-muted small fw-bold mb-2">Total Devolución</h6>
                                    <div className="d-flex align-items-center">
                                        <DollarSign className="text-success me-1" size={24} />
                ...
                <div className="col-12">
                    <div className="card border-0 shadow-sm">
                        <div className="card-header bg-white py-3">
                            <h5 className="mb-0 fw-bold">Items de la Nota de Crédito</h5>
                        </div>
